...
Traceback (most recent call last):
  ...
  File "/tmp/babel-pdKdik/python-WtMfJ4", line 15, in <module>
    printTree(libNameToTree("Arith"), 3)
  File "/home/scottviteri/Dropbox/MyBrain/BrainSelf/ModelBuilding/ComputerScience/Programming/TheoremProving/Coq/100FamousProofs/utils.py", line 58, in printTree
    for x in printTreeHelper(tree):
  File "/home/scottviteri/Dropbox/MyBrain/BrainSelf/ModelBuilding/ComputerScience/Programming/TheoremProving/Coq/100FamousProofs/utils.py", line 54, in printTreeHelper
    return [h] + list(map(lambda x: "+---"+x, t))
  File "/home/scottviteri/Dropbox/MyBrain/BrainSelf/ModelBuilding/ComputerScience/Programming/TheoremProving/Coq/100FamousProofs/utils.py", line 54, in <lambda>
    return [h] + list(map(lambda x: "+---"+x, t))
