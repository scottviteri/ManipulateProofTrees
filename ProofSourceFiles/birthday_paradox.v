...
(* Ex 1 -- both can do, one simplification *)
(* Do stages 0 and 1 *)
...
(* Ex 2 -- both can do, significant savings *)
(* Show exact spot where turned into axiom *)
...
(* Ex 3 -- First where original cannot succeed *)
(* Dig into lemma and show where slows down on subcomponents *)
...
(* Ex 4 *)
(* Major theorem. Only modified can handle *)
